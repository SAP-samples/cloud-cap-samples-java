...
public class AdminServiceAddressITestBase {
  ...
  private static final String remoteAddressURI =
      "/api/API_BUSINESS_PARTNER/A_BusinessPartnerAddress(BusinessPartner='%s',AddressID='%s')";
  ...
  public void testAddressesValueHelp() {
    client
        ...
        .jsonPath("$.value[2].ID")
        .isEqualTo("300")
        .jsonPath("$.value[2].businessPartner")
        .isEqualTo("10401010");
  }
  ...
  public void testOrderWithAddress() throws InterruptedException {
    ...
    client
        .get()
        .uri(orderURI.formatted(id) + "?$expand=shippingAddress")
        .headers(this::adminCredentials)
        .exchange()
        .expectStatus()
        .isOk()
        ...
        .jsonPath("$.shippingAddress.ID")
        .isEqualTo("100")
        .jsonPath("$.shippingAddress.businessPartner")
        .isEqualTo("10401010")
        .jsonPath("$.shippingAddress.houseNumber")
        .isEqualTo("16");

    client
        .get()
        .uri(orderURI.formatted(id) + "/shippingAddress")
        .headers(this::adminCredentials)
        .exchange()
        .expectStatus()
        .isOk()
    ...
    bupa.on(
        BusinessPartnerChangedContext.CDS_NAME,
        null,
        (context) ->
            context
                .getChangeSetContext()
    ...
    client
        .patch()
        .uri(remoteAddressURI.formatted("10401010", "100"))
