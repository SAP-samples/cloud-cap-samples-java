...
@Profile("!cloud")
@ServiceName(
    value = {ApiBusinessPartner_.CDS_NAME, "api-business-partner-mocked"},
    type = ApplicationService.class)
public class ApiBusinessPartnerEventMockHandler implements EventHandler {

  private static final Logger logger =
      LoggerFactory.getLogger(ApiBusinessPartnerEventMockHandler.class);
    ...
    String businessPartner =
        (String)
            analyzer
                ...
                .targetKeys()
                .get(ABusinessPartnerAddress.BUSINESS_PARTNER);
